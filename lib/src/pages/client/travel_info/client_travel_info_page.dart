...
import 'package:taxi_service/src/pages/client/travel_info/client_travel_info_controller.dart';
import 'package:taxi_service/src/widgets/button_app.dart';

class ClienteTravelInfoPage extends StatefulWidget {
  const ClienteTravelInfoPage({Key key}) : super(key: key);
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text(
              '${_con.minTotal?.toStringAsFixed(0) ?? '0.0'}\$ - ${_con.maxTotal?.toStringAsFixed(0) ?? '0.0'}\$',
              style: TextStyle(
                  fontSize: 13
              ),
              maxLines: 1,
